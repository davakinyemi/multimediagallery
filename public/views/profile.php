...
<section class="mr-top-default">
    <form method="POST" action="<?= PATH_BASE ?>/update-profile" enctype="multipart/form-data" class="form-box w90 center items-flex align-center just-space-between flex-wrap-dv-small">
        ...
        <div class="col w50 w100-dv-small">
            <figure class="img-bigger-user">
                <img src="<?= PATH_UPLOADS ?>/images/users/<?= $_SESSION['image'] ?>" />
            </figure>
        </div>
    </form>
</section>